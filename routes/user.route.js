...
import { getNameAndEmail, login, logout, userRegister, logoutAll, getAllUsers, adminLogout, softDeleteUser, hardDeleteUser, changeRole,viewDirectories,viewFiles,viewSingleFile } from "../controllers/user.controller.js";
...
router.get("/users/:userId/files", checkAuth, checkRole, viewFiles)
router.get("/users/:userId/directories", checkAuth, checkRole, viewDirectories)
router.get("/users/:userId/files/:fileId", checkAuth, checkRole, viewSingleFile)
