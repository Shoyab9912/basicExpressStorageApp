...
router.post("/upload/initiate",writeAccess,uploadInitiate)
router.post("/upload/complete",writeAccess,uploadComplete)
router.delete("/cancel/:fileId",writeAccess,cancelUpload)
